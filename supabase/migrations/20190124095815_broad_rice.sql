/*
  # Loan Application System Schema

  1. New Tables
    - `applications`
      - Core table for loan application data
      - Includes all form fields, metadata, and timestamps
      - Encrypted sensitive data columns
    - `audit_logs`
      - Tracks all data access and modifications
      - Includes user info, action type, and timestamps
    - `export_jobs`
      - Manages Excel export tasks
  ...
  3. Functions
    - Add helper functions for data operations
